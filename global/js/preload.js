...
(this.createjs = this.createjs || {}),
	...
	(createjs.deprecate = function (a, b) {
		...
		return function () {
			var c =
				"Deprecated property or method '" + b + "'. See docs for info.";
			return (
		...
		(EventDispatcher.initialize = function (b) {
				...
				a
					? (this._listeners && delete this._listeners[a],
					  this._captureListeners &&
							delete this._captureListeners[a])
			...
			(a._dispatchEvent = function (a, b) {
				...
				if (a && e && (d = e[a.type]) && (c = d.length)) {
					...
					for (
						var g = 0;
						c > g && !a.immediatePropagationStopped;
						g++
					) {
						var h = d[g];
						h.handleEvent ? h.handleEvent(a) : h(a),
							a.removed &&
								(this.off(a.type, h, 1 == b), (a.removed = !1));
					}
				}
		...
		(a.ABSOLUTE_PATT = /^(?:\w+:)?\/{2}/i),
			...
			(a.parseURI = function (b) {
				...
				return (
					...
					(g = b.match(a.EXTENSION_PATT)) &&
						(c.extension = g[1].toLowerCase()),
					c
				);
			}),
			...
			(a.isLocal = function (a) {
				var b = createjs.Elements.a();
				return (
					(b.href = a.src), "" == b.hostname && "file:" == b.protocol
				);
			}),
			(createjs.URLUtils = a);
	})(),
		...
		(b.LOAD_TIMEOUT_DEFAULT = 8e3),
			(b.create = function (a) {
				...
				if (a instanceof Object && a.src)
					return (
						null == a.loadTimeout &&
							(a.loadTimeout = b.LOAD_TIMEOUT_DEFAULT),
						a
					);
		...
		(a.getItem = function () {
			...
			(a._sendError = function (a) {
				!this._isCanceled() &&
					...
					(null == a &&
						(a = new createjs.ErrorEvent("PRELOAD_ERROR_EMPTY")),
					this.dispatchEvent(a));
			}),
					...
					case "complete":
						...
						b instanceof Function
							? b.call(
									this,
									createjs.proxy(
										this._resultFormatSuccess,
										this
									),
									createjs.proxy(
										this._resultFormatFailed,
										this
									)
							  )
	...
	(function () {
		...
		function TagRequest(a, b, c) {
			this.AbstractRequest_constructor(a),
				...
				(this._loadedHandler = createjs.proxy(
		...
		(a.load = function () {
			...
			(createjs.TagRequest = createjs.promote(
				TagRequest,
				"AbstractRequest"
			));
	})(),
	...
	(function () {
		...
		function XHRRequest(a) {
			this.AbstractRequest_constructor(a),
				...
				(this._handleAbortProxy = createjs.proxy(
					this._handleAbort,
					this
				)),
				(this._handleErrorProxy = createjs.proxy(
					this._handleError,
					this
				)),
				(this._handleTimeoutProxy = createjs.proxy(
					this._handleTimeout,
					this
				)),
				(this._handleLoadProxy = createjs.proxy(
					this._handleLoad,
					this
				)),
		...
		(XHRRequest.ACTIVEX_VERSIONS = [
			...
			(a.load = function () {
				...
				try {
					this._item.values
						? this._request.send(
								createjs.URLUtils.formatQueryString(
									this._item.values
								)
						  )
						: this._request.send();
					...
					this.dispatchEvent(
						new createjs.ErrorEvent("XHR_SEND", null, a)
					);
				}
			}),
			(a.setResponseType = function (a) {
				"blob" === a &&
					((a = window.URL ? "blob" : "arraybuffer"),
			...
			(a._handleAbort = function (a) {
				this._clean(),
					this.dispatchEvent(
						new createjs.ErrorEvent("XHR_ABORTED", null, a)
					);
			}),
			...
			(a._createXHR = function (a) {
				...
				null == a.mimeType &&
					...
					(this._xhrLevel =
						"string" == typeof d.responseType ? 2 : 1);
				var i = null;
				if (
					((i =
			...
			(createjs.XHRRequest = createjs.promote(
				XHRRequest,
				"AbstractRequest"
			));
	})(),
	...
	(function () {
		...
		(a.init = function (a, b, c) {
				...
				if (b) {
					for (; b.length; ) {
						...
						if (e) this._disposeItem(this.getItem(d));
							...
							for (
								var f = this._currentLoads.length - 1;
								f >= 0;
								f--
							) {
			...
			(a.reset = function () {
				...
				for (
					var b = [], c = 0, d = this._loadQueueBackup.length;
					d > c;
					c++
				)
			...
			(a._createLoadItem = function (a, b, c) {
				...
				if (d.src instanceof Object) {
					...
					h.extension && (d.ext = h.extension),
						null == d.type &&
							(d.type = createjs.RequestUtils.getTypeByExtension(
								d.ext
							));
					var i = d.src;
				...
				(d.path = e),
					(void 0 === d.id || null === d.id || "" === d.id) &&
						(d.id = i);
				var j =
					this._typeCallbacks[d.type] ||
					this._extensionCallbacks[d.ext];
				if (j) {
				...
				return (
					...
					null == d.crossOrigin &&
						(d.crossOrigin = this._crossOrigin),
					d
				);
			}),
			...
			(a._processFinishedLoad = function (a, b) {
				if (
					(this._numItemsLoaded++,
					!this.maintainScriptOrder &&
						a.type == createjs.Types.JAVASCRIPT)
				) {
					var c = b.getTag();
			...
			(a._updateProgress = function () {
				...
				if (b > 0) {
					for (
						var c = 0, d = 0, e = this._currentLoads.length;
						e > d;
						d++
					)
			...
			(createjs.LoadQueue = createjs.promote(
				LoadQueue,
				"AbstractLoader"
			));
	})(),
	...
	(function () {
		...
		var a =
			(createjs.extend(TextLoader, createjs.AbstractLoader), TextLoader);
		(a.canLoadItem = function (a) {
			return a.type == createjs.Types.TEXT;
		}),
			(createjs.TextLoader = createjs.promote(
				TextLoader,
				"AbstractLoader"
			));
	})(),
	...
	(function () {
		...
		function CSSLoader(a, b) {
			this.AbstractLoader_constructor(a, b, createjs.Types.CSS),
				...
				(this._tag = b
					? createjs.Elements.style()
					: createjs.Elements.link()),
		...
		(b.canLoadItem = function (a) {
			...
			(createjs.CSSLoader = createjs.promote(
				CSSLoader,
				"AbstractLoader"
			));
	})(),
	...
	(function () {
		...
		(FontLoader.canLoadItem = function (a) {
			return (
				a.type == createjs.Types.FONT ||
				a.type == createjs.Types.FONTCSS
			);
		}),
			(FontLoader.sampleText =
				"abcdefghijklmnopqrstuvwxyz ABCDEFGHIJKLMNOPQRSTUVWXYZ"),
			(FontLoader._ctx = document
			...
			(a._handleTimeout = function () {
				this._stopWatching(),
					this.dispatchEvent(
						new createjs.ErrorEvent("PRELOAD_TIMEOUT")
					);
			}),
			(a._createRequest = function () {
			...
			(a._watchCSS = function () {
				...
				return (
					...
					-1 !== a.search(/\n|\r|@font-face/i)
						? (this._parseCSS(a), !0)
						: ((this._request = new createjs.XHRRequest(
								this._item
						  )),
						  !1)
				);
			...
			(a._watchFontArray = function () {
				for (
					var a, b = this._item.src, c = "", d = b.length - 1;
					d >= 0;
					d--
				) {
					var e = b[d];
			...
			(a._watch = function () {
				for (
					...
					for (
						var e = a[d], f = e.refs, g = f.length - 1;
						g >= 0;
						g--
					) {
			...
			(a._calculateReferenceSizes = function (a) {
				for (
					var b = FontLoader._referenceFonts,
						c = (a.refs = []),
						d = 0;
					d < b.length;
					d++
			...
			(createjs.FontLoader = createjs.promote(
				FontLoader,
				"AbstractLoader"
			));
	})(),
		...
		function ImageLoader(a, b) {
			this.AbstractLoader_constructor(a, b, createjs.Types.IMAGE),
				...
				createjs.DomUtils.isImageTag(a)
					...
					? (this._tag = a.src)
					: createjs.DomUtils.isImageTag(a.tag) &&
					  (this._tag = a.tag),
				null != this._tag
					? (this._preferXHR = !1)
		...
		(b.canLoadItem = function (a) {
			...
			(a._updateXHR = function (a) {
				(a.loader.mimeType =
					...
					a.loader.setResponseType &&
						a.loader.setResponseType("blob");
			}),
			...
			(createjs.ImageLoader = createjs.promote(
				ImageLoader,
				"AbstractLoader"
			));
	})(),
	...
	(function () {
		...
		(b.canLoadItem = function (a) {
			...
			(createjs.JSONLoader = createjs.promote(
				JSONLoader,
				"AbstractLoader"
			));
	})(),
	...
	(function () {
		...
		(b.canLoadItem = function (a) {
			...
			(createjs.JSONPLoader = createjs.promote(
				JSONPLoader,
				"AbstractLoader"
			));
	})(),
	...
	(function () {
		...
		(b.MANIFEST_PROGRESS = 0.25),
			...
			(a._handleManifestProgress = function (a) {
				(this.progress =
					a.progress * (1 - b.MANIFEST_PROGRESS) +
					b.MANIFEST_PROGRESS),
	...
	(function () {
		...
		function VideoLoader(a, b) {
			this.AbstractMediaLoader_constructor(a, b, createjs.Types.VIDEO),
				createjs.DomUtils.isVideoTag(a) ||
				createjs.DomUtils.isVideoTag(a.src)
	...
	(function () {
		...
		(b.SPRITESHEET_PROGRESS = 0.25),
			...
			(a._handleManifestProgress = function (a) {
				(this.progress =
					a.progress * (1 - b.SPRITESHEET_PROGRESS) +
					b.SPRITESHEET_PROGRESS),
					this._sendProgress(this.progress);
			}),
			(a._handleManifestError = function (a) {
				var b = new createjs.Event("fileerror");
	...
	(function () {
		...
		(b.canLoadItem = function (a) {
			...
			(createjs.SVGLoader = createjs.promote(
				SVGLoader,
				"AbstractLoader"
			));
	})(),
	...
	(function () {
		...
		(b.canLoadItem = function (a) {
			...
			(createjs.XMLLoader = createjs.promote(
				XMLLoader,
				"AbstractLoader"
			));
	})();
