		...
		this.innerHTML = `	
			<section class="flex-col--center">
				...
				<figure class="folio-grid p2 border-r01 back-grey__light06">
					<img src="${data.designs.ui01Path}" alt="${data.designs.ui01Alt}">
					<figcaption class="folio-caption justify-self-center">
						${data.designs.ui01Caption}
					</figcaption>
				</figure>
                <div class="folio-content__text">
					<button 
						data-figma="${data.designs.figmaLink}"
						class="btn-primary width-reading mt1">
					...
					<h3 class="h3 mt3 mb025">${data.designs.settingsTitle}</h3>	
					${Object.values(data.designs.settingsText)
						.map((value) => {
							return `<p>${value}</p>`;
						})
						.join("")}	
					<figure>
						<img src="${data.designs.settingsPath}" alt="${data.designs.settingsAlt}">
					</figure>	
					<button 
						data-figma="${data.designs.settingsFigma}"
						class="btn-primary width-reading mt1">
							<svg class="icon-figma" viewBox="0 0 38 57" xmlns="http://www.w3.org/2000/svg">
								<path fill="#1ABCFE" d="M19 28.5C19 25.9804 20.0009 23.5641 21.7825 21.7825C23.5641 20.0009 25.9804 19 28.5 19C31.0196 19 33.4359 20.0009 35.2175 21.7825C36.9991 23.5641 38 25.9804 38 28.5C38 31.0196 36.9991 33.4359 35.2175 35.2175C33.4359 36.9991 31.0196 38 28.5 38C25.9804 38 23.5641 36.9991 21.7825 35.2175C20.0009 33.4359 19 31.0196 19 28.5Z" />
								<path fill="#0ACF83" d="M0 47.5C0 44.9804 1.00089 42.5641 2.78249 40.7825C4.56408 39.0009 6.98044 38 9.5 38H19V47.5C19 50.0196 17.9991 52.4359 16.2175 54.2175C14.4359 55.9991 12.0196 57 9.5 57C6.98044 57 4.56408 55.9991 2.78249 54.2175C1.00089 52.4359 0 50.0196 0 47.5Z" />
					...
					<h3 class="h3 mt3 mb025">${data.designs.modalTitle}</h3>	
					${Object.values(data.designs.modalText)
						.map((value) => {
							return `<p>${value}</p>`;
						})
						.join("")}	
					<figure class="width-full folio-grid folio-grid--2col p1 border-r01 back-grey__light05">
						<img src="${data.designs.modalPath01}" alt="${data.designs.modalAlt01}">
						<img src="${data.designs.modalPath02}" alt="${data.designs.modalAlt02}">
					</figure>
					<button 
						data-figma="${data.designs.modalFigma}"
						class="btn-primary width-reading mt1">
							<svg class="icon-figma" viewBox="0 0 38 57" xmlns="http://www.w3.org/2000/svg">
								<path fill="#1ABCFE" d="M19 28.5C19 25.9804 20.0009 23.5641 21.7825 21.7825C23.5641 20.0009 25.9804 19 28.5 19C31.0196 19 33.4359 20.0009 35.2175 21.7825C36.9991 23.5641 38 25.9804 38 28.5C38 31.0196 36.9991 33.4359 35.2175 35.2175C33.4359 36.9991 31.0196 38 28.5 38C25.9804 38 23.5641 36.9991 21.7825 35.2175C20.0009 33.4359 19 31.0196 19 28.5Z" />
								<path fill="#0ACF83" d="M0 47.5C0 44.9804 1.00089 42.5641 2.78249 40.7825C4.56408 39.0009 6.98044 38 9.5 38H19V47.5C19 50.0196 17.9991 52.4359 16.2175 54.2175C14.4359 55.9991 12.0196 57 9.5 57C6.98044 57 4.56408 55.9991 2.78249 54.2175C1.00089 52.4359 0 50.0196 0 47.5Z" />
