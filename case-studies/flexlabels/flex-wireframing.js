		...
		this.innerHTML = `	
			<section class="flex-col--center">
				...
				<figure class="folio-grid p2 border-r01 back-grey__light06">
					<img src="${data.wireframing.ui01Path}" alt="${data.wireframing.ui01Alt}">
					<figcaption class="folio-caption justify-self-center">
						${data.wireframing.ui01Caption}
					</figcaption>
				</figure>
                <div class="folio-content__text mt1">
					<button 
						data-figma="${data.wireframing.figmaLink}"
